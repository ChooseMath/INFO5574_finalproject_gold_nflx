...
For the monthly analysis, the merged dataset combined_goldandnflx_monthly.csv was used to provide a more detailed view of the relationship between gold prices and Netflix stock performance. The original daily Netflix stock data was aggregated into monthly average adjusted closing prices, while the gold price data was also represented as monthly average USD prices. The two datasets were merged using Year and Month as common keys. This monthly dataset allows the analysis to capture more observations than the yearly dataset and provides a clearer view of short-term patterns, trends, and correlations between monthly gold prices and monthly Netflix adjusted closing prices.
